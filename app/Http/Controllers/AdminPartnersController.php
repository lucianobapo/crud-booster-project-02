<?php namespace App\Http\Controllers;
	...
	class AdminPartnersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Tipo de Parceiro","name"=>"partner_type_id","join"=>"partner_types,type"];
			...
			$this->form[] = ['label'=>'Tipo de Parceiro','name'=>'partner_type_id','type'=>'select2','validation'=>'required','width'=>'col-sm-9','datatable'=>'partner_types,type'];

            $columns = [];
            $columns[] = ['label'=>'Número do Documento','name'=>'document_number','type'=>'number','required'=>true];
            $columns[] = ['label'=>'Tipo do Documento','name'=>'document_type_id','type'=>'select','datatable'=>'document_types,type'];
